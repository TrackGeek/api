...
export class CommentController {
  ...
  async addCommentToProfile(@Session() session: UserSession, @Body() body: AddCommentToProfileDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToGame(@Session() session: UserSession, @Body() body: AddCommentToGameDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToManga(@Session() session: UserSession, @Body() body: AddCommentToMangaDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToAnime(@Session() session: UserSession, @Body() body: AddCommentToAnimeDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToTVShow(@Session() session: UserSession, @Body() body: AddCommentToTVShowDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToBook(@Session() session: UserSession, @Body() body: AddCommentToBookDto) {
  ...
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async addCommentToMovie(@Session() session: UserSession, @Body() body: AddCommentToMovieDto) {
