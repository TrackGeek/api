...
import { GameCommentFindManyArgs, ProfileCommentFindManyArgs } from '@prisma/generated/models';
...
export class CommentService {
  ...
  async getCommentsByProfileId(profileId: string) {
    ...
    const pagination = await this.prismaService.cursorPagination<ProfileCommentFindManyArgs>({
  ...
  async getCommentsByGameId(gameId: string) {
    ...
    const pagination = await this.prismaService.cursorPagination<GameCommentFindManyArgs>({
      model: 'gameComment',
      where: { gameId },
      include: {
        comment: {
