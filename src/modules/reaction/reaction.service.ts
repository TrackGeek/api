...
export class ReactionService {
  ...
  async getReactionsByCommentId(commentId: string) {
    ...
    const pagination = await this.databaseService.cursorPagination<CommentReactionFindManyArgs>({
  ...
  async getReactionsByFeedEventId(feedEventId: string) {
    ...
    const pagination = await this.databaseService.cursorPagination<FeedEventReactionFindManyArgs>({
