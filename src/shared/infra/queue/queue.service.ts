...
import { FEED_EVENT_JOB, MAGIC_LINK_JOB, RESET_PASSWORD_JOB } from '@/shared/constants/job';

type QueueName = typeof EMAIL_QUEUE | typeof FEED_EVENT_QUEUE;

type JobName = typeof FEED_EVENT_JOB | typeof MAGIC_LINK_JOB | typeof RESET_PASSWORD_JOB;
